...
export const GITHUB_PROJECTS = [
    {img: goku, href:'https://github.com/edwinoko/crawler', key: 'crawler', label: 'Manga crawler', tech:['Python']},
    {img: fgc, href:'https://github.com/edwinoko/Universal-Fighting-Game-Platform', key: 'UFGP', label: 'Universal Fighting Game Platform', tech:['Next.js','tailwindcss']},
    {img: moves, href:'https://github.com/edwinoko/Game-Domain-API', key: 'FGD',  label: 'Fighting Game Domain', tech: ['fastApi']},
];
